...
public final class Address {
	...
	private Address(final StreetAddress newStreetAddress, final City newCity,
	...
	public static class AddressBuilder {
		...
		public AddressBuilder(final City newCity, final String newState) {
			this.nestedCity = newCity;
			this.nestedState = new State(newState);
		}
