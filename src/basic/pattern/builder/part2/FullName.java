...
public final class FullName {
	...
	private FullName(final Name newLastName, final Name newFirstName,
			final Name newMiddleName, final Salutation newSalutation,
	...
	public static class FullNameBuilder {
		...
		public FullName createFullName() {
			return new FullName(nestedLastName, nestedFirstName,
